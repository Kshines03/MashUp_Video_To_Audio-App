...
import os
st.title('Melodious Mix(MashUp)- A combination of melody and mix, it suggests a seamless blend of songs from different artists.')
st.write('~By Kashita Wadhwa')
...
# Email credentials
        from_email = "kashita.wadhwa00@gmail.com"
        to_email = Email
        password = "agbrxnyzsdyhyriu"
